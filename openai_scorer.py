"""
Prompt Quality Scoring Agent - OpenAI version
Requires: pip install langchain langchain-openai
Usage: OPENAI_API_KEY=sk-... python openai_scorer.py "Your prompt here"
"""
import os
import json
import re
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: OPENAI_API_KEY=sk-... python openai_scorer.py 'Your prompt here'")
        sys.exit(1)
